								...
								<div class="tabbable portlet-tabs">
									<div class="tab-content">
                                       ...
                                       <div  class="row">
                                           <div class="span2"></div>
										   <div class="span8">
											<form action="<%=request.getContextPath() %>/teacher/updTeacher" name="Form1"  class="form-horizontal" method="post">								
											
												<div class="control-group hidden"  >
													<label class="control-label">教师ID:</label>
													<div class="controls">
														<input type="text" name="id" value="${teacher.id}" class="span8" />													
													</div>
												</div>	
												...
												<div class="control-group"  style="margin-top: 130px">
													...
													<div class="controls">
														<input type="text" name="name" value="${teacher.name}" placeholder="" class="span8" />
														<span class="help-block">请输入教师姓名</span>
													</div>
												</div>	
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" name="teacher_num" value="${teacher.teacher_num}" placeholder="" class="span8" />
														<span class="help-block">请输入教学编号</span>
													</div>
												</div>																											
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" name="phone_num" value="${teacher.phone_num}" placeholder="" class="span8" />
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="text" name="email" placeholder="" value="${teacher.email}" class="span8" />
														<span class="help-block">请填写有效的邮箱地址</span>
													</div>
												</div>	
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="password"  placeholder="" value="${teacher.password}" class="span8" disabled/>													
													</div>
												</div>	
