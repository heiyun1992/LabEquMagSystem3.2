...
<body>
	<div id="wrap">
      ...
      <div class="main_container" id="dashboard_page1">
       <form  action="<%=request.getContextPath() %>/equipemnt/addEquipment" name="Form1" method="post">
 		<br>
	...
	<tr>			
		 ...
		 <td >
         	<input type="text" name="name"  id="name" class="input-mini" />
         </td>   	    
      	 	
    		    
        <td >
         	<select name="type" id="type" class="input-mini">
         ...
         <td >
         	<input type="text" name="models"  id="models" class="input-mini" />
         </td>
                  			
            
         <td>
        	 <input type="text" name="price"  id="price"  class="input-medium"/>
         </td>   
         
         <td>
        	 <input type="text" name="vender"  id="vender"  class="input-medium"/>
         </td>   
         
         <td>
        	 <input type="text" name="purchase_date"  id="purchase_date"  class="input-medium"/>
         </td>          
	</tr>
