...
<body>
	<div id="wrap">
		...
		<div class="container-fluid">
			...
			<div class="sidebar-nav nav-collapse collapse">
				<div class="user_side clearfix">
					...
					<h5>${admin.name}</h5>
					<a href="admin/updateAdmin1"><i class="icon-cog"></i>设置</a>
				</div>
      ...
      <div class="main_container" id="dashboard_page1">
       <form  action="<%=request.getContextPath() %>/admin/updateAdmin" name="Form1" method="post">
 		<br>
	...
	<tr>			              
		 <td >
    	  ...
    	  <td >
         	<input type="text" name="password"  id="password" class="input-mini" />
         </td>
         	    
        <td>
         	<select name="role" id="role" class="input-mini">
		...
		<div class=" control-group" id="password2">
          ...
          <div class=" control-group" id="npassword2">
                 ...
                 <div class="controls">
                        <input type="text" class="input-medium" id="npassword" name="repassword">
