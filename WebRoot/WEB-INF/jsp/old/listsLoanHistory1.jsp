			...
			<div class="sidebar-nav nav-collapse collapse">
					...
					<div class="accordion-group">
						...
						<div id="collapse4" class="accordion-body collapse">
							<div class="accordion-inner">
								 ...
								 <a class="accordion-toggle" href="${pageScope.basePath }loan/getAllLoanHistory"><i class="icon-table"></i>出借历史</a>
				...
				<div class="main_container" id="dashboard_page1">
						 <table class="table table-striped">
							...
							<tbody>
							<c:forEach var="list" items="${LoanHistoryLists}">
								<tr>
					...
					<ul>
						<li><a href="loan/getAllLoanEquipment?pageNow=1">首页</a></li>
						<c:choose>
							<c:when test="${page.pageNow - 1 > 0}">
								<li><a href="loan/getAllLoanEquipment?pageNow=${page.pageNow - 1}">上一页</a></li>
							</c:when>
							<c:when test="${page.pageNow - 1 <= 0}">
								<li><a href="loan/getAllLoanEquipment?pageNow=1">上一页</a></li>
							</c:when>
						</c:choose>

						<c:forEach var="item" varStatus="status" begin="1"
							end="${page.pageNow-1}">
							<li><a href="loan/getAllLoanEquipment?pageNow=${status.index}">${status.index}</a></li>
						</c:forEach>
						<li class="active"><a
							href="loan/getAllLoanEquipment?pageNow=${page.pageNow}">${page.pageNow}</a></li>
						...
						<c:choose>
							<c:when test="${page.totalPageCount==0}">
								<li><a href="loan/getAllLoanEquipment?pageNow=${page.pageNow}">下一页</a></li>
							</c:when>
							<c:when test="${page.pageNow + 1 < page.totalPageCount}">
								<li><a href="loan/getAllLoanEquipment?pageNow=${page.pageNow + 1}">下一页</a></li>
							</c:when>
							<c:when test="${page.pageNow + 1 >= page.totalPageCount}">
								<li><a href="loan/getAllLoanEquipment?pageNow=${page.totalPageCount}">下一页</a></li>
							</c:when>
						</c:choose>
						<c:choose>
							<c:when test="${page.totalPageCount==0}">
								<li><a href="loan/getAllLoanEquipment?pageNow=${page.pageNow}">尾页</a></li>
							</c:when>
							<c:otherwise>
								<li><a href="loan/getAllLoanEquipment?pageNow=${page.totalPageCount}">尾页</a></li>
							</c:otherwise>
						</c:choose>
					</ul>
				</div>			 --%>	
