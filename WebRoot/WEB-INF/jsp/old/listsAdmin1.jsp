		...
		<div class="container-fluid">
			...
			<div class="sidebar-nav nav-collapse collapse">
				...
				<div class="main_container" id="dashboard_page1">
					...
					<ul>
						<li><a href="getAllEquipment.do?pageNow=1">首页</a></li>
						<c:choose>
							<c:when test="${page.pageNow - 1 > 0}">
								<li><a href="getAllEquipment.do?pageNow=${page.pageNow - 1}">上一页</a></li>
							</c:when>
							<c:when test="${page.pageNow - 1 <= 0}">
								<li><a href="getAllEquipment.do?pageNow=1">上一页</a></li>
							</c:when>
						</c:choose>

						<c:forEach var="item" varStatus="status" begin="1"
							end="${page.pageNow-1}">
							<li><a href="getAllEquipment.do?pageNow=${status.index}">${status.index}</a></li>
						</c:forEach>
						<li class="active"><a
							href="getAllEquipment.do?pageNow=${page.pageNow}">${page.pageNow}</a></li>
						...
						<c:choose>
							<c:when test="${page.totalPageCount==0}">
								<li><a href="getAllEquipment.do?pageNow=${page.pageNow}">下一页</a></li>
							</c:when>
							<c:when test="${page.pageNow + 1 < page.totalPageCount}">
								<li><a href="getAllEquipment.do?pageNow=${page.pageNow + 1}">下一页</a></li>
							</c:when>
							<c:when test="${page.pageNow + 1 >= page.totalPageCount}">
								<li><a href="getAllEquipment.do?pageNow=${page.totalPageCount}">下一页</a></li>
							</c:when>
						</c:choose>
						<c:choose>
							<c:when test="${page.totalPageCount==0}">
								<li><a href="getAllEquipment.do?pageNow=${page.pageNow}">尾页</a></li>
							</c:when>
							<c:otherwise>
								<li><a href="getAllEquipment.do?pageNow=${page.totalPageCount}">尾页</a></li>
							</c:otherwise>
						</c:choose>
					</ul>
				</div> --%>				
