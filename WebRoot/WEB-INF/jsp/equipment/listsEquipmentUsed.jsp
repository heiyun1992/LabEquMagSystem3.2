			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="portlet box blue">
							...
							<div class="portlet-body">
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody id="newbody">
									<c:forEach var="list" items="${equipmentUesdLists}">
										<tr class="">
											...
											<td><a class="btn mini" href="${pageScope.basePath }laboratory/getLaboratoryById/${list.laboratoryId}">${list.laboratoryId}</a></td>
											<td>${list.used_date}</td>
											<%-- <td>${fn:replace(list.used_date, "year", "年")}</td> --%>
											<%-- <td><a class="btn mini red" href="${pageScope.basePath }equipment/updEquipment?updId=${list.id}" > 修改</a></td> --%>
										</tr>	
										</c:forEach>				
									</tbody>
								</table>
						...
						<!-- <input type="button" id="list_export" value="导出" class="btn blue"> -->
						<button  type="submit" id="list_export" class="btn blue"><i class="icon-ok"></i> 导出&nbsp;&nbsp;</button>
						<button  type="submit" id="list_export1" class="btn blue"><i class="icon-ok"></i> 导入&nbsp;&nbsp;</button>
					</div>
				</div>
				<!-- END PAGE CONTENT -->
			</div>
