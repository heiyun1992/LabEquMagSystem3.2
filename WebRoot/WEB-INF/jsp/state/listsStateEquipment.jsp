				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">仪器损坏管理</a><span class="icon-angle-right"></span>
							</li>
							<li>
					...
					<div class="span12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>损坏仪器列表</div>
							...
							<div class="portlet-body">
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody id="newbody">
									<c:forEach var="list" items="${stateEquipmentLists}">
										<tr class="">
											<!-- <td><input type="checkbox" class="checkboxes" value="1" /></td> -->
											<td><a class="btn mini" href="#">${list.equipment.name}</a></td>
											<td>${list.equipment.laboratoryId}</td>
											<td class="center">${list.teacher.name}</td>
											<td>${list.admin.name}</td>
											<td>${list.describement}</td>
											
											<!-- <td><a class="delete btn mini red" href="" id="bt_back"> 归还</a></td> -->
											<td><button  class="btn mini red" id="repair"
								 onclick="if(window.confirm('确定设备[${list.equipment.name}]已修好吗?')==true){window.location.href='${pageScope.basePath }state/delStateEquipment/${list.id}'}">
								 已修复</button>
