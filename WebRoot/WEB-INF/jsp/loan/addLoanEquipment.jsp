				...
				<div class="row-fluid">
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="#">仪器租借管理</a><span class="icon-angle-right"></span></li>
							<li><a href="#">租借登记</a></li>
						</ul>
					</div>
				</div>
						...
						<div class="portlet box blue tabbable">
							<div class="portlet-title">
								<div class="caption">
									...
									<span class="hidden-480">&nbsp;&nbsp;租借登记</span>
								</div>
							</div>
								...
								<div class="tabbable portlet-tabs">
									<div class="tab-content">
                                       ...
                                       <div  class="row">
                                           <div class="span2"></div>
										   <div class="span8">
											<form action="<%=request.getContextPath() %>/loan/addLoanEquipment" name="Form1"  class="form-horizontal" method="post">
												<div class="control-group"  style="margin-top: 130px">
													<label class="control-label">设备名称</label>
													<div class="controls">
														<select name="equipment_id" id="equipment_id" class="span8" tabindex="1">
															<option value=" "></option>
															<c:forEach var="equipment" items="${equipmentLists}">
        														<option value="${equipment.id}">${equipment.name}</option>														
															</c:forEach>
														</select>
														<span class="help-block">请选择设备</span>
													</div>
												</div>																														
												...
												<div class="control-group">
													...
													<div class="controls">								
														<select name="teacher_id" id="equipment_id" class="span8" tabindex="1">
															<option value=" "></option>
												...
												<div class="control-group">
													<label class="control-label">出借日期</label>
													<div class="controls" >													
														 <div class="input-append date date-picker"  data-date-format="yyyy-mm-dd" data-date-viewmode="years">
															<input readonly="readonly" class="m-wrap m-ctrl-medium date-picker" name="loan_date" size="16" type="text"  >
												...
												<div class="control-group hidden">
													...
													<div class="controls">								
														 <input type="text" name="admin_id"  id="vender" value="${admin.id}"  class="span8 hidden"  />
													</div>
												</div>																																				
