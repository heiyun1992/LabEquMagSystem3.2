		...
		<div class="page-content">
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
						<h3 class="page-title">
							 仪器管理<small>&nbsp;实验室列表</small>
						</h3>
						<ul class="breadcrumb">
							<li>
								<i class="icon-home"></i>
								<a href="index.html">仪器设备系统</a> 
					...
					<div class="span12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>实验室列表</div>
							...
							<div class="portlet-body">
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody id="newbody">
									<c:forEach var="list" items="${laboratoryList}">
										<tr class="">
											<%-- <td><a class="btn mini" href="">${list.id}</a></td> --%>
											<td>${list.name}</td>
											<td>${list.academybelong}</td>
											<td>${list.address}</td>											
											<td>
												<a class="btn mini blue" href="${pageScope.basePath }admin/updAdmin?updId=${list.id}" > 编辑</a>
												<button  class="btn mini blue"
								 onclick="if(window.confirm('确定要删除[${list.name}]吗?')==true){window.location.href='${pageScope.basePath }laboratory/delLaboratory/${list.id}'}">
								 删除</button>											
											</td>
										</tr>	
										</c:forEach>				
