...
<body class="page-header-fixed">
								...
								<div class="tabbable portlet-tabs">
									<div class="tab-content">
                                       ...
                                       <div  class="row">
                                           <div class="span2"></div>
										   <div class="span8">
											<form action="<%=request.getContextPath() %>/admin/updateAdmin" name="Form1"  class="form-horizontal" method="post">								
																						
											    <div class="control-group hidden" >
													<label class="control-label">id:</label>
													<div class="controls">
														<input type="password" name="id" value="${admin.id}" placeholder="" class="span8" />										
													</div>
												</div>	
												...
												<div class="control-group"  style="margin-top: 130px">
													...
													<div class="controls">
														<input type="password"  value="${admin.password}" placeholder="" class="span8" disabled/>
												...
												<div class="control-group">
													...
													<div class="controls">
														<input type="password"  placeholder=""  class="span8" id="repassword"/>	
														<span class="help-block" id="password2"></span>												
													</div>
												</div>																																																					
	...
	$(document).ready( function(){  
		...
		//var repassword=$("#repassword").val(); 
		alert(name==repasseord)
			if(repassword==""||name!=repassword){
				$("#password2").html("两次输入的密码不一样！！！").css("color","red");
			}else{
				$("#password2").html("");
			}	
		});			
