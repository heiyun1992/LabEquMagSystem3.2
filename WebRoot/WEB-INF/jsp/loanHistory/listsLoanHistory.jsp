					...
					<div class="span12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>历史列表</div>
								...
								<!-- 			<th style="width:8px;"><input type="checkbox" class="group-checkable" data-set="#sample_editable_1 .checkboxes"/></th> -->
									...
									<c:forEach var="list" items="${LoanHistoryLists}">
										<tr class="">
											...
											<td>${fn:split(list.return_date, " ")[0]}</td>
											<!-- <td><a class="delete btn mini red" href="#" > 修改</a></td> -->
										</tr>	
										</c:forEach>				
									</tbody>
								</table>
