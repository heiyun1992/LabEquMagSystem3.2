										...
										<div class="portlet-body form">
											...
											<form action="<%=request.getContextPath() %>/scrap/addScrapedEquipment" name="Form1" method="post" class="form-horizontal form-bordered">
												<div class="control-group hidden">
													...
													<div class="controls">											
														<input type="text" name="equipment_id"  value="${aEquipment.id}" class="span12" />														
													</div>
												</div>
												...
												<div class="control-group hidden">
													...
													<div class="controls">											
														<input type="text" name="admin_id"  value="${admin.id}" class="span12" />														
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls">											
														<input type="text"  value="${aEquipment.name}"  placeholder="" class="span12" disabled="disabled"/>														
													</div>
												</div>
												...
												<div class="control-group">
													...
													<div class="controls" style="margin-top: 15px">
														<div class="input-append date date-picker"  data-date-format="yyyy-mm-dd" data-date-viewmode="years">
															<input readonly="readonly" class="m-wrap m-ctrl-medium date-picker" name="checked_date" size="16" type="text"  >
												...
												<div class="control-group">
                                                    ...
                                                    <ckeditor:editor basePath="ckeditor/"  editor="scrap_describe" />     
