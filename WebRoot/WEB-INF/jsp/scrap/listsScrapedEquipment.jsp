					...
					<div class="span12">
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-reorder"></i>报废仪器列表</div>
							...
							<div class="portlet-body">
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody id="newbody">
									<c:forEach var="list" items="${scrapedEquipmentList}">
										<tr class="">
											...
											<td>${list.scrap_describe}</td>
											<td><a href="${pageScope.basePath }scrap/detailScrapedEquipment?fId=${list.id}">点击</a></td>
